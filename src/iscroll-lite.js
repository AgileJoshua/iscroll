...
(function () {
	...
	iScroll = function (el, options) {
	    ...
	    that.velocityX = that.options.velocityX;
	    that.velocityY = that.options.velocityY;
    ...
    iScroll.prototype = {
        ...
        _end: function (e) {
            ...
            if (duration < 300 && that.options.momentum) {
                ...
                momentumY = newPosY ? that._momentum(newPosY - that.startY, duration, -that.y, (that.maxScrollY < 0 ? that.scrollerH - that.wrapperH + that.y : 0), that.options.bounce ? that.wrapperH : 0, that.velocityY) : momentumY;
        ...
        _startAni: function () {
            ...
            animate = function () {
                ...
                if (timeDiff == 0) {
                    ...
                    that.velocityX = (newX - startX) / timeDiff;
                    that.velocityY = (newY - startY) / timeDiff;
                }
                that._pos(newX, newY);
